...
function Consulting() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-[3.75rem] w-full h-[calc(100%_-_6.625rem_-_3.75rem)] overflow-scroll scroll-smooth py-8 px-[7.75rem]"
        ref={scrollRef}
        onScroll={() => {
          reveal();
        }}
      >
        <div className="transition duration-1000 reveal">
          <iframe
            className="w-full h-[39.375rem] rounded-3xl mb-6"
            width="560"
            height="315"
...
function ConsultingReport() {
  return (
    <div className="w-full p-10 bg-white border rounded-xl border-neutral-400">
      <p className=" text-[2rem] font-bold text-black mb-10">
      ...
      <div className="relative flex items-start justify-between before:w-px before:h-full before:bg-neutral-300 before:absolute before:top-0 before:left-1/2">
        <div className="w-1/2 ">
          <div className="flex items-center mb-5">
            <p className=" w-[10.625rem] text-2xl font-medium text-neutral-500">
              주간평균 온도
            </p>
          ...
          <div className="flex items-center mb-5">
            ...
            <p className=" text-[1.75rem] font-bold text-black">8도 이상</p>
          </div>
          <p className=" text-[1.75rem] font-bold text-[#2EABE2]">
            생식생장 예측
          </p>
        </div>
        <div className="w-1/2 pl-10">
          <div className="flex items-center mb-5">
            <p className="text-2xl w-[10.625rem] font-medium text-neutral-500">
              첫급액시간
            </p>
            <p className=" text-[1.75rem] font-bold text-black">10 : 00</p>
          </div>
          <div className="flex items-center mb-5">
            <p className="text-2xl w-[10.625rem] font-medium text-neutral-500">
              첫배액시간
            </p>
            <p className=" text-[1.75rem] font-bold text-black">12 : 00</p>
          </div>
          <div className="flex items-center mb-5">
            <p className="text-2xl w-[10.625rem] font-medium text-neutral-500">
              급액시간
